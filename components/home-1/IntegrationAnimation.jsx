    ...
    <>
      <div className="relative -z-10 mx-auto -mt-15 max-w-[1068px] max-md:hidden">
        <div className="relative z-10 w-full py-[175px] max-xl:py-150 max-lg:py-25">
          <div className="align-center shadow-nav dark:bg-dark-200 relative mx-auto flex h-150 w-150 flex-row justify-center rounded-full bg-white">
            <div className="align-center bg-primary-100 absolute top-1/2 left-1/2 mx-auto flex h-[122px] w-[122px] -translate-x-1/2 -translate-y-1/2 flex-row justify-center rounded-full dark:bg-[#2B2D2A]">
              <span className="text-primary inline-block px-[25px] py-[46px] text-[30px] leading-none font-semibold">
                aplio
              </span>
            </div>
          </div>
          <div className="absolute top-0 right-auto bottom-auto left-0 block h-full w-1/2">
            ...
            <div className="absolute top-[58px] right-auto bottom-auto left-25 -z-10 w-auto leading-0 max-xl:top-[42px] max-lg:top-5">
              <svg
                width="100%"
                height="193"
                viewBox="0 0 437 193"
            ...
            <div className="absolute top-1/2 right-auto bottom-auto left-25 -z-10 w-auto -translate-y-1/2 leading-0">
              <svg
                width="100%"
                height="2"
                viewBox="0 0 373 2"
            ...
            <div className="absolute top-auto right-auto -bottom-[38px] left-25 -z-10 w-auto -translate-y-1/2 leading-0 max-xl:-bottom-[54px] max-lg:-bottom-[76px]">
              <svg
                width="100%"
                height="193"
                viewBox="0 0 437 193"
          ...
          <div className="absolute top-0 right-0 bottom-auto left-auto block h-full w-1/2">
            ...
            <div className="absolute top-[58px] right-25 bottom-auto left-auto -z-10 w-auto leading-0 max-xl:top-[42px] max-lg:top-5">
              <svg
                width="100%"
                height="193"
                viewBox="0 0 437 193"
            ...
            <div className="absolute top-1/2 right-25 bottom-auto left-auto -z-10 w-auto -translate-y-1/2 leading-0">
              <svg
                width="100%"
                height="2"
                viewBox="0 0 373 2"
            ...
            <div className="absolute top-auto right-25 -bottom-[38px] left-auto -z-10 w-auto -translate-y-1/2 leading-0 max-xl:-bottom-[54px] max-lg:-bottom-[76px]">
              <svg
                width="100%"
                height="193"
                viewBox="0 0 437 193"
