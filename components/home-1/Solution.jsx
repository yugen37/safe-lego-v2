          ...
          <div className="max-md:order-1 lg:-mt-15">
            ...
            <ul className="mb-14 flex max-lg:mb-6 max-md:flex-col max-md:gap-y-5 lg:items-center lg:[&>*:not(:last-child)]:mr-10">
              <li className="relative flex items-center gap-x-2">
                ...
                <span className="font-jakarta font-medium dark:text-white">On Demand Support</span>
              </li>
              <li className="relative flex items-center gap-x-2">
                <FaCheck className="text-paragraph dark:text-primary" />
                <span className="font-jakarta font-medium dark:text-white">Information Sharing</span>
              </li>
              <li className="relative flex items-center gap-x-2">
                <FaCheck className="text-paragraph dark:text-primary" />
                <span className="font-jakarta font-medium dark:text-white">Cloud Technology</span>
              </li>
            </ul>
