    ...
    <section className="pt-16 pb-20 md:pt-[90px] md:pb-[150px] lg:pt-[100px] lg:pb-[200px]" aria-label="Contact Us">
      <div className="container">
        <div className="flex flex-col items-start justify-between gap-8 lg:flex-row lg:gap-4">
              ...
              <li className="flex items-center gap-3.5">
                <svg
                  ...
                  <path
                    ...
                    fill=""
                    className="fill-paragraph dark:fill-white"></path>
                </svg>
                <p>
                  <Link href="mailto:hello@aplio.com" aria-label="Email us at hello@aplio.com">
                    hello@aplio.com
                  </Link>
                </p>
              </li>
          ...
          <div className="relative z-10 w-full lg:ml-auto lg:max-w-[560px] xl:max-w-[605px]">
            ...
            <FadeUpAnimation className="dark:bg-dark-200 rounded-medium shadow-nav bg-white p-2.5">
              <div className="dark:bg-dark-200 dark:border-borderColour-dark rounded border border-dashed border-gray-100 bg-white p-12 max-md:p-5">
                <form action="/index.html" method="post">
                  <fieldset className="mb-8 flex w-full flex-col items-start justify-start gap-2">
                    ...
                    <input
                      ...
                      className="border-borderColour dark:border-borderColour-dark text-paragraph-light placeholder:text-paragraph-light dark:placeholder:text-paragraph-light dark:bg-dark-200 focus:border-primary dark:focus:border-primary block w-full rounded-[48px] border bg-white px-5 py-2.5 text-sm outline-hidden transition-all duration-300"
                      aria-required="true"
                    />
                  </fieldset>
                  ...
                  <fieldset className="mb-4 flex w-full flex-col items-start justify-start gap-2">
                    ...
                    <textarea
                      ...
                      rows="5"
                      className="border-borderColour dark:border-borderColour-dark text-paragraph-light placeholder:text-paragraph-light dark:bg-dark-200 focus:border-primary dark:focus:border-primary block w-full resize-none rounded border bg-white px-5 py-2.5 text-sm outline-hidden transition-all duration-300"
