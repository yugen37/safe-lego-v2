    ...
    <section className="relative pb-25 max-md:overflow-hidden max-md:pb-25">
      <div className="relative container max-md:text-center">
        <div className="absolute -bottom-[442px] left-1/2 -z-10 flex -translate-x-1/2 max-md:hidden max-md:flex-col">
          <div className="bg-primary-200/20 max-1xl:h-[335px] max-1xl:w-[335px] 1xl:h-[442px] 1xl:w-[442px] rounded-full blur-[145px] max-md:hidden"></div>
              ...
              <form>
                <div className="grid grid-cols-12 items-center max-lg:gap-y-5 lg:gap-x-6">
                  <input
                    ...
                    className="placeholder:text-light text-light border-borderColour focus:border-primary dark:bg-dark-200 dark:focus:border-primary h-full rounded-[60px] border bg-transparent bg-white ps-5 leading-[1.75] text-[#A1A49D] transition-all duration-300 outline-none focus:outline-none max-lg:col-span-full max-lg:py-3.5 lg:col-span-8 dark:border-[#31332F] dark:placeholder:text-[#A1A49D]"
                  />
