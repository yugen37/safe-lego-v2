...
const WhyUs = () => {
  ...
  return (
    <section className="relative overflow-hidden pt-[200px]">
      <div className="[&>*:nth-child(odd)]:after:bg-full relative z-10 container [&>*:nth-child(odd)]:after:absolute [&>*:nth-child(odd)]:after:bottom-0 [&>*:nth-child(odd)]:after:left-1/2 [&>*:nth-child(odd)]:after:h-0.5 [&>*:nth-child(odd)]:after:w-full [&>*:nth-child(odd)]:after:-translate-x-1/2 [&>*:nth-child(odd)]:after:bg-[url('/images/payment/seperator.png')] [&>*:nth-child(odd)]:after:bg-center [&>*:nth-child(odd)]:after:bg-no-repeat dark:[&>*:nth-child(odd)]:after:bg-[url('/images/payment/seperator-dark.png')] [&>:nth-child(even)]:pt-25 max-md:[&>:nth-child(even)]:pt-10 lg:[&>:nth-child(even)]:pt-[200px] [&>:nth-child(odd)]:pb-25 max-md:[&>:nth-child(odd)]:pb-0 lg:[&>:nth-child(odd)]:pb-150">
        <div className="1xl:gap-x-24 relative grid grid-cols-2 items-end gap-25 max-md:grid-cols-1 max-md:gap-10">
          <motion.div
            ...
            />
            <div className="max-xs:w-8/12 absolute bottom-2.5 left-1/2 mx-auto aspect-video w-[400px] -translate-x-1/2 max-lg:w-8/12 max-md:w-1/2">
              <Image src={WHyUsImageLight} alt="hero Image" className="rounded-t-medium inline-block dark:hidden" />
              <Image src={WHyUsImageDark} alt="hero Image" className="rounded-t-medium hidden dark:inline-block" />
            </div>
          </motion.div>
        ...
        <div className="1xl:gap-x-24 relative grid grid-cols-2 items-end gap-25 max-md:grid-cols-1">
          <div className="relative max-md:order-1">
            ...
            <ul className="mb-14 max-w-[490px] [&>*:not(:last-child)]:mb-5">
              <li className="dark:border-borderColour-dark flex items-center gap-x-5 rounded border border-dashed border-gray-100 p-2.5">
                ...
                <span className="font-jakarta font-semibold"> It’s scalable and secure </span>
              </li>
              <li className="dark:border-borderColour-dark flex items-center gap-x-5 rounded border border-dashed border-gray-100 p-2.5">
                <span className="shadow-icon dark:bg-dark-200 relative h-10 w-10 gap-6 rounded-full bg-[#F3F8E8]">
                  <FaCheck className="text-primary absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                </span>
                <span className="font-jakarta font-semibold"> Cash Flow Statements </span>
              </li>
            </ul>
