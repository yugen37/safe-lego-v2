            ...
            <div className="relative z-10 mx-auto max-w-[510px]">
              ...
              <div className="rounded-medium shadow-nav dark:bg-dark-200 bg-white p-2.5">
                <div className="dark:border-borderColour-dark dark:bg-dark-200 rounded border border-dashed border-gray-100 bg-white p-12 max-md:px-5 max-md:py-7">
                  <form>
                    <div className="grid grid-cols-12 gap-y-6">
                      <div className="col-span-12">
                        <label
                          htmlFor="name"
                          className="font-jakarta-paragraph mb-2 block text-sm font-medium dark:text-white">
                          Your Name
                        </label>
                        <input
                          type="text"
                          ...
                          className="border-borderColour text-paragraph-light placeholder:text-paragraph-light focus:border-primary dark:border-borderColour-dark dark:bg-dark-200 dark:placeholder:text-paragraph-light dark:focus:border-primary block w-full rounded-[48px] border bg-white px-5 py-2.5 text-sm outline-none"
                        />
                      </div>
                      <div className="col-span-12">
                        <label
                  ...
                  <div className="mb-8">
                    <button className="group border-borderColour font-jakarta-paragraph dark:border-borderColour-dark mb-6 flex w-full items-center justify-center gap-2 rounded-[30px] border bg-white px-[30px] py-3.5 text-sm font-medium -tracking-[0.3px] max-md:px-5 dark:bg-transparent dark:text-white">
                      ...
                      <span className="font-jakarta-medium"> Continue with Google </span>
                    </button>
                    <button className="group border-borderColour font-jakarta-paragraph dark:border-borderColour-dark flex w-full items-center justify-center gap-2 rounded-[30px] border bg-white px-[30px] py-3.5 text-sm font-medium -tracking-[0.3px] max-md:px-5 dark:bg-transparent dark:text-white">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
