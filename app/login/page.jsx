    ...
    <>
      ...
      <main>
        <section className="relative mb-150 pt-[200px] max-md:mb-25">
          <div className="absolute top-25 left-1/2 -z-10 h-[550px] w-full -translate-x-1/2 bg-[url('/images/hero-gradient.png')] bg-cover bg-center bg-no-repeat opacity-70 md:hidden"></div>
            ...
            <div className="relative z-10 mx-auto max-w-[510px]">
              ...
              <div className="rounded-medium shadow-nav dark:bg-dark-200 bg-white p-2.5">
                <div className="dark:border-borderColour-dark dark:bg-dark-200 rounded border border-dashed border-gray-100 bg-white p-12 max-md:px-5 max-md:py-7">
                  <div>
                    <button className="group border-borderColour font-jakarta text-paragraph dark:border-borderColour-dark mb-6 flex w-full items-center justify-center gap-2 rounded-[30px] border bg-white px-[30px] py-3.5 text-sm font-medium -tracking-[0.3px] max-md:px-5 dark:bg-transparent dark:text-white">
                    ...
                    <button className="group border-borderColour font-jakarta text-paragraph dark:border-borderColour-dark flex w-full items-center justify-center gap-2 rounded-[30px] border bg-white px-[30px] py-3.5 text-sm font-medium -tracking-[0.3px] max-md:px-5 dark:bg-transparent dark:text-white">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
                  ...
                  <div className="after:border-borderColour dark:after:border-borderColour-dark relative py-8 after:absolute after:top-1/2 after:h-[1px] after:w-full after:-translate-y-1/2 after:border after:border-dashed">
                    ...
                    <div className="grid grid-cols-12 gap-y-6">
                      <div className="col-span-12">
                        ...
                        <input
                          ...
                          className="border-borderColour text-paragraph-light placeholder:text-paragraph-light focus:border-primary dark:border-borderColour-dark dark:bg-dark-200 dark:placeholder:text-paragraph-light dark:focus:border-primary block w-full rounded-[48px] border bg-white px-5 py-3.5 text-sm transition-all duration-300 outline-none"
                        />
                      </div>
                      <div className="col-span-full">
                        ...
                        <input
                          ...
                          className="border-borderColour text-paragraph-light placeholder:text-paragraph-light focus:border-primary dark:border-borderColour-dark dark:bg-dark-200 dark:focus:border-primary block w-full rounded-[48px] border bg-white px-5 py-3.5 text-sm transition-all duration-300 outline-none"
                        />
                      </div>
                      <div className="col-span-full flex items-center justify-between">
                        <label htmlFor="remember-me" className="flex items-center gap-x-3">
                          ...
                          <div className="border-borderColour after:bg-primary peer-checked:border-primary dark:border-borderColour-dark dark:peer-checked:border-primary relative h-5 w-5 cursor-pointer rounded-full border after:absolute after:top-1/2 after:left-1/2 after:h-2.5 after:w-2.5 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full after:opacity-0 peer-checked:after:opacity-100"></div>
                        ...
                        <Link
                          ...
                          className="font-jakarta text-paragraph before:bg-paragraph relative inline-block overflow-hidden align-bottom text-sm leading-[24px] font-medium before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100 dark:text-white dark:before:bg-white">
                          Forget Password
                        </Link>
                      </div>
                      <div className="col-span-full">
                      ...
                      <div className="col-span-full">
                        <p className="font-jakarta text-center text-sm leading-[24px] font-medium">
                          Not registered yet?
                          <Link
                            href="/signup"
                            className="font-jakarta text-paragraph before:bg-paragraph relative inline-block overflow-hidden align-bottom text-sm leading-[24px] font-medium before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100 dark:text-white dark:before:bg-white">
